...
def log_kpi_live(
    ...
    agent_decision: Annotated[str, Field(description="critical_maintenance / safety_violation / quality_defect / normal")] = "normal",
    alert_type: Annotated[str, Field(description="ANOMALY_ALERT, SAFETY_ALERT, DEFECT_ALERT, NORMAL")] = "NORMAL",
    action_taken: Annotated[str, Field(description="shutdown_conveyor / notify_supervisor / flag_anomaly / none")] = "none",
